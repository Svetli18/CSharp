namespace _01._BrowserHistory.Tests
{
    ...
    public class BrowserHistoryTests
    {
        ...
        [Test]
        public void LastVisitedLinkOnEmptyCollection()
        {
            ...
            {
                this._browserHistory.LastVisited();
            });
        }
        ...
        [Test]
        public void DeleteFirstOnEmptyCollection()
        {
            this._browserHistory.Clear();

            Assert.Throws<InvalidOperationException>(() =>
            {
                this._browserHistory.DeleteFirst();
            });
        }
        ...
        [Test]
        public void DeleteLastOnEmptyCollection()
        {
            this._browserHistory.Clear();

            Assert.Throws<InvalidOperationException>(() =>
            {
                this._browserHistory.DeleteLast();
            });
        }
        ...
        [Test]
        public void RemoveLinksOnEmptyCollection()
        {
            var history = new BrowserHistory();
            ...
            int actualCount = history.RemoveLinks("youtube");
            int actualCount2 = history.RemoveLinks("google");
            ILink[] actualLinks = history.ToArray();
            ...
            Assert.Throws<InvalidOperationException>(() =>
            {
                int actualCount3 = history.RemoveLinks("youtube");
            });
        }
        ...
        [Test]
        public void ContainsReturnsFals()
        {
            Link testLink = new Link("Svetli", 100);
            Assert.IsFalse(this._browserHistory.Contains(testLink));
        }
